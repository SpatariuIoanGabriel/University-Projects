...
class IteratedList {
private:
// Static array for elements and links between them
    static const int cp = 100000;
    TElem elements[cp];
    int next[cp];
    int prev[cp];
...
// Index of the first element in the array of free spaces
    int firstEmpty;

// Functions for allocating and deallocating a free space
// Returns the index of a free space in the array
    int allocate();
